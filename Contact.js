...
function colorCycle() {
    ...
    p1.style.color = "rgb(" + (255 - (255 - r)) + "," + (255 - (255 - g)) + "," + (b) + ")";
    p2.style.color = "rgb(" + (255 - (255 - r)) + "," + (255 - (255 - g)) + "," + (b) + ")";
    p3.style.color = "rgb(" + (255 - (255 - r)) + "," + (255 - (255 - g)) + "," + (b) + ")";
    p4.style.color = "rgb(" + (255 - (255 - r)) + "," + (255 - (255 - g)) + "," + (b) + ")";
